...
class Solver(object):
    ...
    def solve_FOM(
        ...
        # Assembler.py builds matrices and vectors used by the FOM. converts PDE into algebraic matrices        
        ...
        """
        Starts from initial zero conditions: u_x=u_y=p=0. Then Newton iterates.
        Each iteration: assembles nonlinear convection operator using current u. Build Jacobian matrix. Solve linear correction system. Update solution. Compute relative increment. Stop if relative increment is small enough (residual_norm <= newton_tol * solution_norm)
        """
        # Newton Method
